  ...
  return (
    <div className="fixed inset-0 grain flex items-center justify-center bg-ink px-6 text-center">
      ...
      <div className="relative max-w-md">
        <div className="mx-auto mb-8 flex h-16 w-16 items-center justify-center rounded-full border-2 border-evidence/70">
          <span className="font-stencil text-2xl text-evidence">!</span>
        </div>
        <p className="hud-chip mb-3 text-evidence/80">CLASSIFIED</p>
        ...
        <p className="mt-6 font-type text-xs tracking-widest text-lamp/70">{t('gate.hint')}</p>
      </div>
    </div>
  )
}
